...
if __name__ == '__main__':
    result = predict('''
    a,lon,lat,surface_total,surface_covered,rooms,l2,l3,dRailway,dIndustrialArea,dAirport,dEducation,dFireStation,dHealthBuilding,dPenitentiary,dPort,dSecureBuilding,dTrainStation,dUniversity,dSubway,property_type
